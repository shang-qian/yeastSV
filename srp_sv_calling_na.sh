...
do
    ...
    minimap2 -t 24 --MD -x map-ont -R "@RG\tID:default\tSM:$srr" $reference_genome $line -a |samtools view -bS > ../$organism/$srp/$srr.mm2.bam
...
do
    ...
    ngmlr -t 24 -r $reference_genome -q $line -o ../$organism/$srp/$srr.ngmlr.bam -x ont
